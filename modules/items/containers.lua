...
setContainerProperties('wallet', {
	slots = 10,
	maxWeight = 3000,
	whitelist = { 'money', 'id_card', 'driver_license', 'weaponlicense', 'huntinglicense', 'fishinglicense', 'lawyerpass', 'forged_id', 'forged_weaponslicense', 'forged_huntinglicense', 'forged_fishinglicense'}
})
